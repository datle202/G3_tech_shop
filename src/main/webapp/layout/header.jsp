    ...
    <div class="header-top">
        <div class="container">
            <div class="top-bar left">
                <ul>
                    <li><a href="#"><i class="fa fa-envelope" aria-hidden="true"></i> onlineShop1@gmail.com</a></li>
    ...
    <div class="header-bottom">
        <div class="container">
            <div class="main-content">
                <div class="logo">
                    <img onclick="window.location = 'Home'" src="images/ShopLazaki.png" alt="biolife logo" width="auto" height="120">
                </div>
                <div class="main-menu">
                    <ul>
